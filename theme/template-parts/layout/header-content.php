...
<header id="masthead">
	<nav id="site-navigation" class="flex items-center justify-between max-w-3xl p-4 mx-auto">
		...
		<ul class="flex items-center space-x-2 text-sm font-medium text-gray-500">
			...
			<li>
				<a class="inline-flex items-center px-3 py-2 rounded-lg" href="" target="_blank">
					External
					<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="ml-1.5 w-4 h-4">
