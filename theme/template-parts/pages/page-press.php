<section class="mx-auto w-max mt-[10.438rem]">
    <h1 class="uppercase font-bold">Media Mention</h1>

    <ul class="relative grid grid-cols-4 items-center justify-items-center gap-4">
        <?php
        ...
        ?>
                ...
                <li class="border-1 mt-[1.5rem] w-[261px]">
                    ...
                    <figure class="h-[190px] w-[261px] bg-no-repeat bg-cover bg-center mt-[1.5rem]" style="background-image: url(<?php echo wp_get_attachment_image_url($press_thumbnail, "full"); ?>);"></figure>
                </li> <?php
