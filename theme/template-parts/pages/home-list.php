...
?>
        ...
        <section id="home-list-bg" class="h-full md:h-[70vh] w-full relative hero bg-no-repeat bg-cover md:grid-cols-2 md:grid-rows-3 md:justify-center" style="background-image: url(<?php echo wp_get_attachment_image_url($list_background_image, "full"); ?>);">
            ...
            <ul class="w-full h-auto py-8 md:py-0 md:col-start-2 leading-[25px] row-start-3 row-end-4 md:row-start-2 md:row-end-3">
